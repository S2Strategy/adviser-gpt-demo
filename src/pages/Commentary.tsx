        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="border-b border-foreground/10 bg-background">
            ...
            <div className="flex items-center justify-between px-6 pb-6 max-w-[100rem] mx-auto">
              <div>
                <h1 className="text-2xl font-semibold">Commentary</h1>
                <p className="text-foreground/70">Market commentary and analysis</p>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <p className="text-foreground/50">
                    This section will contain market commentary and analysis features.
                  </p>
                </div>
              </div>
            </div>
